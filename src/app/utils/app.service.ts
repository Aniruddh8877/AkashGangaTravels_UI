...
export class AppService {
  ...
  saveHotelCategory(obj: any) {
    return this.http.post(this.apiUrl + "HotelCategory/saveHotelCateogry", obj, { headers: this.headers })
  }
  ...
  getListByDestinationList(obj: any) {
    return this.http.post(this.apiUrl + "Package/ListByDestination", obj, { headers: this.headers })
  }
  savePackage(obj: any) {
    return this.http.post(this.apiUrl + "Package/savePackage", obj, { headers: this.headers })
  }
  ...
  saveEnquiry(obj: any) {
    return this.http.post(this.apiUrl + "Enquiry/SaveEnquriy", obj, { headers: this.headers })
  }
