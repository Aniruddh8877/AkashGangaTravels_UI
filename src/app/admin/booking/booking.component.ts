...
export class BookingComponent {
  ...
  //calculation and selection code start here!!!
  ...
  onDateFieldsChange() {
    const arrival = this.Booking.ArivalDate ? new Date(this.Booking.ArivalDate) : null;
  ...
  saveBooking() {
    ...
    this.Booking.TravelDate = this.Booking.ArivalDate;
    this.Booking.Rate = this.Booking.AmountQuoted;

    this.Booking.BookingDate = this.loadData.loadDate(new Date());
    this.Booking.TravelDate = this.loadData.loadDate(new Date());
    this.Booking.ArivalDate = this.loadData.loadDate(new Date());
    this.Booking.DepartureDate = this.loadData.loadDate(new Date());
    this.Guest.DOB = this.loadData.loadDate(new Date());
